...
f + geom_line() + labs( x = "Year", y = "Uninsured Population Rate", title = "Uninsured Population Rate in Each State, 2008 - 2014")

# it might help to filter these - lowest
f <- medicaid_expansion %>% filter(year < 2014, uninsured_rate < 0.08) %>%  ggplot(mapping = aes(x = year, y = uninsured_rate, color = State))

f + geom_line() + labs(x = "Year", y = "Uninsured Population Rate", title = "Uninsured Population Rate in Each State (Lower Bound), 2008 - 2014")

# it might help to filter these - highest
h <- medicaid_expansion %>% filter(year < 2014, uninsured_rate > 0.20) %>%  ggplot(mapping = aes(x = year, y = uninsured_rate, color = State)) 

h + geom_line() + labs( x = "Year", y = "Uninsured Population Rate", title = "Uninsured Population Rate in Each State (Upper Bound), 2008 - 2014")
